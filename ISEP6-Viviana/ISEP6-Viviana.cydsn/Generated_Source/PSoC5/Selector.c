...
*
* \funcusage
*  \snippet Selector_SUT.c usage_Selector_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Selector_SUT.c usage_Selector_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Selector_SUT.c usage_Selector_Read  
*******************************************************************************/
...
* preferred Selector_Read() API because the 
* Selector_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Selector_SUT.c usage_Selector_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Selector_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Selector_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Selector_0_INTR       (First pin in the list)
    *  - Selector_1_INTR       (Second pin in the list)
    *  - ...
    *  - Selector_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Selector_SUT.c usage_Selector_SetInterruptMode
    *******************************************************************************/
    void Selector_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Selector_0_INTR) != 0u) 
		{ 
			 Selector_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Selector_SUT.c usage_Selector_ClearInterrupt
    *******************************************************************************/
